...
acc_misalignment, acc_scale, acc_bias = load_calibration('./calib_data/mpu_params2/test_imu_acc.calib')
gyro_misalignment, gyro_scale, gyro_bias = load_calibration('./calib_data/mpu_params2/test_imu_gyro.calib')
