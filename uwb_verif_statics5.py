...
slope_scatter, intercept_scatter = np.polyfit(scatter_fit_df['Average_Distance (m)'], scatter_fit_df['Ground_Truth_Distance (m)'], 1)
linear_fit_scatter = slope_scatter * scatter_fit_df['Average_Distance (m)'] + intercept_scatter

# Plot the linear fit
plt.plot(
    scatter_fit_df['Average_Distance (m)'],
    linear_fit_scatter,
    linestyle='-',
    color='purple',
...
# -----------------------------
# 15. Print the Scatter Linear Fit Equation
# -----------------------------
